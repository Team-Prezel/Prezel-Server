...
public class AuthController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "유효하지 않은 ID Token", content = @Content(
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "401", description = "토큰 에러 (만료, 탈취 의심 등)", content = @Content(
                    mediaType = "application/json",
                    examples = {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "401", description = "인증 필요 (Header에 Access Token 누락)", content = @Content(
                    mediaType = "application/json",
                    examples = @ExampleObject(value = "{\n  \"status\": 401,\n  \"code\": \"U001\",\n  \"data\": null,\n  \"message\": \"인증이 필요합니다.\"\n}")
            ))
    })
